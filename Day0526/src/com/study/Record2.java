...
public class Record2 implements Sung {
	...
	public Record2(String name, String[] score, int tot, double avg, int rank) {
		super();
		this.name = name;
		this.score = score;
		this.tot = tot;
